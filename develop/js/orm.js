$(function () {
    ...
    var templateGalleryFile = Handlebars.templates['orm.gallery-file'];
    ...
    $.each($('.js-fragment-container'), function (idx, itm) {
        ...
        var template_section = Handlebars.templates['orm.fragment-section'];
        var template_block = Handlebars.templates['orm.fragment-block'];
        var template_modal_section = Handlebars.templates['orm.fragment-modal-section'];
        var template_modal_block = Handlebars.templates['orm.fragment-modal-block'];
        var template_sidebar = Handlebars.templates['orm.fragment-sidebar'];
