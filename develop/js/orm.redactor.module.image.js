        ...
        _pzImageEdit: function()
        {
            ...
            $.ajax({
                ...
                if (msg.id) {
                    ...
                    var template_crop_image = Handlebars.templates['base.crop-image.twig'];
                    ...
                    $('.js-redactor-save').on('click', function () {
                        ...
                        var template_image = Handlebars.templates['base.crop-image-redactor-img-with-figure.twig'];
